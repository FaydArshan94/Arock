...
//     const imagePath = Array.from({ length: 142 }, (elem, idx) => {
//       return `/src/assets/webf/frame${idx}.png`;
//     });
   
//     const images = []

//     imagePath.forEach(function(path, idx){
//       const img = new Image()
//       img.src = path
...
//     const loadImagesSequence = (timestamp)=>{

//       if(images.length == 142 && timestamp - lastFrame >= 1000/30){
//         ctx.clearRect(0,0,canvas.width,canvas.height)
//         ctx.drawImage(images[currentFrame],0,0,canvas.width,canvas.height)


//         currentFrame = (currentFrame+1) % 142
//         lastFrame = timestamp
        
//       }
//       requestAnimationFrame(loadImagesSequence)
...
//   };
  ...
  //   animation();
  // });
  const head = ["IMPACTFUL", "DESIGN", "IS THE", "DESIGN", "THAT"];
  return (
    <div className="text-center p-5">
      <h3 className="text-gray-500 text-md  font-[anzo3]">
        © anzo.studio 2024 | designed and developed
      </h3>
      <div id="section2" className="mt-12 relative">
        {head.map((item, index) => {
          return (
        ...
        <div className="rotateText relative">
          ...
          <h1 className=" font-[anzo5] text-[42vw] leading-[34vw] ">WORKS</h1>
        </div>
        ...
        <div className="h-0.5 bg-black w-1/4 mt-10 absolute left-1/2 -translate-x-1/2"></div>
      </div>
    </div>
  );
};
